  ...
  return (
    <div className="min-h-[80vh] w-full flex flex-col items-center justify-center pt-20 px-4">
      <div className="w-full max-w-[480px] flex flex-col animate-fade-up opacity-0">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6 bg-pure-white p-8 md:p-10 rounded-[40px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-hairline-mist/50">
          {error && (
            <div className="bg-coral-pop/10 text-coral-pop px-6 py-4 rounded-[20px] text-[15px] font-medium text-center animate-fade-in">
              {error}
            </div>
          )}
          ...
          <div className="text-center mt-2">
            <span className="text-[15px] text-stone-gray font-medium">Don't have an account? </span>
            <Link href="/signup" className="text-[15px] font-bold text-ink-black hover:text-sky-pop transition-colors">
              Sign up
            </Link>
          </div>
        </form>
