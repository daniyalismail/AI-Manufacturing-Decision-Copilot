      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-pure-white/15 pb-6">
          <div className="flex items-center gap-3">
            ...
            <Badge status={recommendedSupplier.status}>
              {recommendedSupplier.status.replace('_', ' ')}
            </Badge>
          </div>
        ...
        <div>
          ...
          <p className="text-[16px] text-sandstone/80 font-medium mt-1">
            {recommendedSupplier.location} • Quoted Total: ${recommendedSupplier.rawCost.toLocaleString()} • Lead Time: {recommendedSupplier.rawTime} days
          </p>
        </div>

        {/* AI Decision Rationale Paragraph */}
        <p className="text-[16px] text-pure-white/90 leading-relaxed font-normal max-w-3xl">
          Vertex Manufacturing achieved the highest overall score because they fully comply with all 4 mandatory criteria (including verified active ISO9001:2015), provide the fastest guaranteed delivery window (15 days vs 20-day limit), and present the lowest operational supply chain risk.
        </p>
